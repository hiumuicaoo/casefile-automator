Bộ biểu mẫu dùng khi "Lãnh đạo ký" là PHÓ TRƯỞNG PHÒNG.

Trên server Ubuntu: upload 8 file .docx (thay các file có sẵn) vào:
  /var/lib/casefile-templates/BIEUMAU_PHOTRUONGPHONG/
